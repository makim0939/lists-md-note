...
namespace NippoWriter.Model
{
    ...
    class SharePointListsService
    {
        ...
        public DailyReportModel GetReportFields()
        {
            ...
            var reportFieldOnly = new DailyReportModel();
            var field1 = new ReportField();
            var field2 = new ReportField();

            field1.Title = "予定と実績";
            field1.Type = "Note";
            reportFieldOnly.Fields.Add(field1);

            field2.Title = "ヒトコト";
            field2.Type = "Note";
            reportFieldOnly.Fields.Add(field2);
